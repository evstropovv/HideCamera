...
/**
 * Created by Vasya on 22.01.2018.
 */
            ...
            if (isFrontCamRequest) {
                ...
                try {
                    if (mCamera != null) {
                        ...
                        Log.d("Log.d", "quality " + parameters.getJpegQuality() + "");
                        Log.d("Log.d", "format " + parameters.getPictureFormat() + "");

                        // set camera parameters
                        mCamera.setParameters(parameters);
                        mCamera.startPreview();
                        Log.d("Log.d", "image taken - OnTake()");
                        mCamera.takePicture(null, null, mCall);
                    } else {
                        handler.post(new Runnable() {
                    ...
                    Log.e("Log.d", "CameraService()::takePicture", e);
                }
                // Get a surface
                /*
